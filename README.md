...
Download Pytorch free - https://pytorch.org/get-started/locally/
(NVIDIA GPU with CUDA needed, or get use one free with [Google Colab](https://colab.research.google.com/))
